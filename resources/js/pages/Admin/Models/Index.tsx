    ...
    return (
        <main className="min-h-screen bg-[#f3f4f6] p-6 md:p-8">
            <div className="mx-auto max-w-7xl">
                <h1 className="text-3xl font-semibold text-slate-900">Manage Models</h1>
                ...
                <form onSubmit={submit} className="mt-6 grid gap-4 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm md:grid-cols-4 md:items-end">
                    <div className="grid gap-1">
                        ...
                        <select value={data.category_id} onChange={(event) => setData('category_id', Number(event.target.value))} className="rounded-lg border border-zinc-300 px-3 py-2">
